class Solution {
    public String longestCommonPrefix(String[] strs) {
        ...
        System.out.println("eqaul to this should be put in a string: " + counter);
        System.out.println(hm);
        String answer = "";
        for(Map.Entry<Character,Integer> stuff : hm.entrySet()){
            if(stuff.getValue() == counter){
                answer += stuff.getKey();
            }
        }
        ...
        for(int i =0; i< answer.length(); i++){
            checker.charAt(i)= answer1.charAt(i);
        }
